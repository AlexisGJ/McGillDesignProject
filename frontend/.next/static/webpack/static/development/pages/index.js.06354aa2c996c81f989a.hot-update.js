    ...
    value: function render() {
      ...
      if (error) {
        ...
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          ...
          data: data.splice(0, Math.floor(data.length / 2)),
          __source: {
            fileName: _jsxFileName,
            lineNumber: 87
          },
          ...
          data: data.splice(Math.floor(data.length / 2), data.length),
          __source: {
            fileName: _jsxFileName,
            lineNumber: 92
          },
...
//# sourceMappingURL=index.js.06354aa2c996c81f989a.hot-update.js.map