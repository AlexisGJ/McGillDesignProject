              ...
              case 0:
                fetch(API_URL + "/api/reading/" + allData.collection_id + "/" + this.state.timeScale).then(function (res) {
                  ...
                  if (result && result.length > 0) {
                    ...
                    var sortedData = stableSort(convertedData, getSorting(_this2.state.order, _this2.state.orderBy));
                    ...
                    _this2.setState({
                      ...
                      lastSuccessfulUpdate: moment__WEBPACK_IMPORTED_MODULE_12___default()()
                    });

                    setTimeout(function () {
                      _this2.showSnackbarMessage("Données mises à jour", "success");
                    }, 1000);
                  } else {
                    _this2.setState({
                      error: null,
                    ...
                    setTimeout(function () {
                      _this2.showSnackbarMessage("Erreur: impossible d'obtenir les données", "error");
                    }, 1000);
                  }
...
//# sourceMappingURL=index.js.1708ff45b7ffef277dc3.hot-update.js.map