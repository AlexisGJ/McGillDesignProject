...
function convertData(data) {
  for (var i = 0; i < data.length; i++) {
    for (var j = 0; j < data[i]['readings'].length; j++) {
      ...
      var diffMinutes = moment__WEBPACK_IMPORTED_MODULE_9___default.a.duration(now.diff(measurementDate)).asMinutes();
...
//# sourceMappingURL=index.js.28a647b3018970d2a85e.hot-update.js.map