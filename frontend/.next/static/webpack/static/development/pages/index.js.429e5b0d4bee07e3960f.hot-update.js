...
function convertData(data) {
  for (var i = 0; i < data.length; i++) {
    for (var j = 0; j < data[i]['readings'].length; j++) {
      ...
      data[i]['readings'][j]['dateFromNowMinutes'] = moment__WEBPACK_IMPORTED_MODULE_9___default()(data[i]['readings'][j]['dateString']).startOf('hour').fromNow();
    }
...
//# sourceMappingURL=index.js.429e5b0d4bee07e3960f.hot-update.js.map