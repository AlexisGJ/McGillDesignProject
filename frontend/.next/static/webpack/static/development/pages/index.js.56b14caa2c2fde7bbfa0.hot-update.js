...
function convertData(data) {
  moment__WEBPACK_IMPORTED_MODULE_9___default.a.locale('fr-CA');
  ...
  for (var i = 0; i < data.length; i++) {
    if (data[i]['readings'] && data[i]['readings'].length > 0) {
      for (var j = 0; j < data[i]['readings'].length; j++) {
        ...
        var diffMinutes = Math.round(moment__WEBPACK_IMPORTED_MODULE_9___default.a.duration(now.diff(measurementDate)).asSeconds());
...
//# sourceMappingURL=index.js.56b14caa2c2fde7bbfa0.hot-update.js.map