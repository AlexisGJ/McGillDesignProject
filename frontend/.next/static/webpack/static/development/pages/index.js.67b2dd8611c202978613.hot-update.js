...
var getAxisYDomain = function getAxisYDomain(data, from, to, ref, offset) {
  var refData = data.slice(to, from);
  console.log(from);
  console.log(to);
  console.log(refData);
    ...
    value: function render() {
      ...
      if (!loaded || !allData._id) {
        ...
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          ...
          __self: this
        })), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(recharts__WEBPACK_IMPORTED_MODULE_11__["Line"], (_React$createElement = {
          yAxisId: "1",
          type: "monotone",
          dataKey: "mmol",
          stroke: "#54a4ef",
          ...
          fileName: _jsxFileName,
          lineNumber: 263
        }), _defineProperty(_React$createElement, "__self", this), _React$createElement)), refAreaLeft && refAreaRight ? react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(recharts__WEBPACK_IMPORTED_MODULE_11__["ReferenceArea"], {
          yAxisId: "1",
          x1: refAreaLeft,
          x2: refAreaRight,
          strokeOpacity: 0.3,
...
//# sourceMappingURL=index.js.67b2dd8611c202978613.hot-update.js.map