      ...
      for (var i = 0; i < data.length; i++) {
        if (data[i]['readings'] && data[i]['readings'].length > 0) {
          ...
          for (var j = 0; j < data[i]['readings'].length; j++) {
            ...
            summaryReading['dateFromNowMinutes'] = data[i]['readings'][j]['dateFromNowMinutes']; //   data[i]['readingsLastHour'].push(summaryReading);
          }
...
//# sourceMappingURL=index.js.7054475532d78edea963.hot-update.js.map