...
function convertData(data) {
  for (var i = 0; i < data.length; i++) {
    for (var j = 0; j < data[i]['readings'].length; j++) {
      data[i]['readings'][j]['dateFromNow'] = moment__WEBPACK_IMPORTED_MODULE_9___default()(data[i]['readings'][j]['dateString']).fromNow();
      data[i]['readings'][j]['dateFromNowMinutes'] = moment__WEBPACK_IMPORTED_MODULE_9___default()(data[i]['readings'][j]['dateString']).fromNow().startOf('hour').fromNow();
    }
      ...
      if (error) {
        ...
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_material_ui_core_Paper__WEBPACK_IMPORTED_MODULE_8___default.a, {
          ...
          return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_material_ui_core_TableRow__WEBPACK_IMPORTED_MODULE_7___default.a, {
            ...
            __self: this
          }, row.latestReading.battery), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_material_ui_core_TableCell__WEBPACK_IMPORTED_MODULE_5___default.a, {
            align: "right",
            __source: {
              fileName: _jsxFileName,
              lineNumber: 121
...
//# sourceMappingURL=index.js.9fa92946230fb740ad1b.hot-update.js.map