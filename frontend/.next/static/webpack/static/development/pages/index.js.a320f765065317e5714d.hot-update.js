...
function convertData(data) {
  for (var i = 0; i < data.length; i++) {
    for (var j = 0; j < data[i]['readings'].length; j++) {
      ...
      var diffMinutes = moment__WEBPACK_IMPORTED_MODULE_9___default.a.duration(now.diff(measurementDate)).asDays();
      data[i]['readings'][j]['dateFromNow'] = measurementDate.fromNow();
      data[i]['readings'][j]['dateFromNowMinutes'] = measurementDate.startOf('hour').fromNow();
    }
...
//# sourceMappingURL=index.js.a320f765065317e5714d.hot-update.js.map