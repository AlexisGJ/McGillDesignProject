              ...
              case 0:
                ...
                fetch("http://localhost:1234/api/reading/allActiveChildren").then(function (res) {
                  ...
                  _this3.setState({
                    ...
                    dataSecondHalf: convertedData // snackbarOpen: true,
                    // snackbarMessage: "Données mises à jour",
                    // snackbarVariant: "success"

                  });

                  setTimeout(_this3.showSnackbarMessage("Données mises à jour", "success"), 1000);
...
//# sourceMappingURL=index.js.b127130c833ba1250ccd.hot-update.js.map