      ...
      for (var i = 0; i < data.length; i++) {
        if (data[i]['readings'] && data[i]['readings'].length > 0) {
          for (var j = 0; j < data[i]['readings'].length; j++) {
            ...
            var diffMinutes = Math.round(moment__WEBPACK_IMPORTED_MODULE_8___default.a.duration(now.diff(measurementDate)).asSeconds());
    ...
    value: function render() {
      ...
      if (this.state.error) {
        ...
        return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
          ...
          __self: this
        }), this.state.loadingData ? "True" : "False", react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_google_login__WEBPACK_IMPORTED_MODULE_7___default.a, {
...
//# sourceMappingURL=index.js.e3d8421c06de2a70382f.hot-update.js.map