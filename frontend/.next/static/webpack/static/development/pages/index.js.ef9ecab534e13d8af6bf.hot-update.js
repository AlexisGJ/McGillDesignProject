...
function convertData(data) {
  for (var i = 0; i < data.length; i++) {
    for (var j = 0; j < data[i]['readings'].length; j++) {
      ...
      var diffMinutes = moment__WEBPACK_IMPORTED_MODULE_9___default.a.duration(now.diff(measurementDate)).asHours();
...
//# sourceMappingURL=index.js.ef9ecab534e13d8af6bf.hot-update.js.map