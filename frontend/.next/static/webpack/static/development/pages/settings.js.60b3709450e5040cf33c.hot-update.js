      ...
      if (error) {
        ...
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          ...
          onClick: function onClick(e) {
            return _this3.createChild(), _this3.handleClose('create_child');
          },
          __source: {
            fileName: _jsxFileName,
            lineNumber: 354
          ...
          return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_material_ui_core_ExpansionPanel__WEBPACK_IMPORTED_MODULE_9___default.a, {
            ...
            size: "small",
            onClick: function onClick(e) {
              return _this3.deleteChild(row), _this3.handleClose(row._id);
            },
            __source: {
              fileName: _jsxFileName,
              lineNumber: 463
            ...
            color: "primary",
            onClick: function onClick(e) {
              return _this3.updateChild(row), _this3.handleClose(row._id);
            },
            __source: {
              fileName: _jsxFileName,
              lineNumber: 464
...
//# sourceMappingURL=settings.js.60b3709450e5040cf33c.hot-update.js.map